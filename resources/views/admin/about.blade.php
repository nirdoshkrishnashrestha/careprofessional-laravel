    ...
    <div class="app-main__inner">
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <strong>About</strong>
                        <div class="page-title-subheading">Add or Edit About
                        </div>
                    </div>
                </div>
        ...
        <td class="text-center">
        <form method="POST" action=" {{ url('admin/about/'.$item->id) }} ">
            @csrf
            @method('DELETE')
           <a href="{{ url('admin/about/'.$item->id.'/edit') }}" class="btn btn-primary btn-sm">Edit</a> 
           {{-- <a href="{{ url('admin/about/'.$item->id.'/delete') }}" class="btn btn-danger btn-sm">Delete</a> --}}
        </form>
        </td>
                            </tr>
                            <?php  $i++; ?>        
                ...
                {{-- This is Add Section Below --}}
                {{-- Un comment if Add Section is Needed --}}
                    ...
                    <div class="card-body">
                        <form action="{{ url('admin/about') }}" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Order:</label>
                                <div class="col-sm-4">
                                    <input type="text" name="order" id="exampleEmail" placeholder="Enter Order Here" class="form-control" required value="{{ old('order') }}">
                                </div>
                                </div>
