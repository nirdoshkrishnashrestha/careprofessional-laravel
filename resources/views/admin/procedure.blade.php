    ...
    <div class="app-main__inner">
            ...
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        ...
                        <div class="page-title-subheading">Add or Edit Procedure
                        </div>
                    </div>
                </div>
        ...
        <td class="text-center">
        <form method="POST" action=" {{ url('admin/procedure/'.$item->id) }} ">
            @csrf
            @method('DELETE')
           <a href="{{ url('admin/procedure/'.$item->id.'/edit') }}" class="btn btn-primary btn-sm">Edit</a> 
           <a href="{{ url('admin/procedure/'.$item->id.'/delete') }}" class="btn btn-danger btn-sm">Delete</a>   
        </form> 
        </td>
                            </tr>
                            <?php  $i++; ?>        
                    ...
                    <div class="card-body">
                        <form action="{{ url('admin/procedure') }}" method="POST" enctype="multipart/form-data" >
                            ...
                            <div class="position-relative row form-group"><label for="file" class="col-sm-2 col-form-label">Image:<small class="form-text text-muted">Please Insert Image Only.</small></label>
                                <div class="col-sm-10">
                                    <input name="image_name" type="file" id="file" class="form-control-file" accept="image/*">
