    ...
    <div class="app-main__inner">
        <div class="app-page-title">
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        <strong>Group</strong>
                        <div class="page-title-subheading">Add or Edit Member
                        </div>
                    </div>
                </div>
        ...
        <td class="text-center">
        <form method="POST" action=" {{ url('admin/group/'.$item->id) }} ">
            @csrf
            @method('DELETE')
           <a href="{{ url('admin/group/'.$item->id.'/edit') }}" class="btn btn-primary btn-sm">Edit</a> 
           <a href="{{ url('admin/group/'.$item->id.'/delete') }}" class="btn btn-danger btn-sm">Delete</a>   
        </form> 
        </td>
                            </tr>
                            <?php  $i++; ?>        
