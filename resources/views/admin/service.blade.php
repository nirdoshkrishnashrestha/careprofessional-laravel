    ...
    <div class="app-main__inner">
            ...
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div>
                        ...
                        <div class="page-title-subheading">Add or Edit Service
                        </div>
                    </div>
                </div>
        ...
        <form method="POST" action=" {{ url('admin/service/'.$item->id) }} ">
            @csrf
            @method('DELETE')
           <a href="{{ url('admin/service/'.$item->id.'/edit') }}" class="btn btn-primary btn-sm">Edit</a> 
           <a href="{{ url('admin/service/'.$item->id.'/delete') }}" class="btn btn-danger btn-sm">Delete</a>   
        </form> 
        </td>
                            </tr>
                            <?php  $i++; ?>        
