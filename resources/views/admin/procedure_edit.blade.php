            ...
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div><strong>Procedure</strong>
                        <div class="page-title-subheading">Edit {{ $procedure->title; }}
                        </div>
                    </div>
                </div>
            ...
            <div class="tab-pane tabs-animation" >
               ...
               @error('image_name')
                ...
                <div class="main-card mb-3 card">
                    ...
                    <div class="card-body">
                    <form action="{{ url('admin/procedure/'.$procedure->id) }}" method="POST" enctype="multipart/form-data" >
                        @csrf
                            <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Title:</label>
                            <div class="col-sm-4">
                <input type="text" name="title" id="exampleEmail" value="{{ $procedure->title }}" class="form-control">
                            </div>
                            </div>                        
                            <div class="position-relative row form-group"><label for="exampleText" class="col-sm-2 col-form-label">Order:</label>
                                <div class="col-sm-4">
                <input type="text" name="order" id="exampleEmail" value="{{ $procedure->order }}" class="form-control">
                                </div>
                            </div>
                            
                            <div class="position-relative row form-group"><label for="exampleText" class="col-sm-2 col-form-label">Content:</label>
                                <div class="col-sm-10">
                  <textarea name="content" id="content" class="form-control">{{ $procedure->content }}</textarea>
                                </div>
                            </div>
                            <div class="position-relative row form-group"><label for="exampleFile" class="col-sm-2 col-form-label">Image: <small class="form-text text-muted">Please Insert Image Only.</small></label>
                                <div class="col-sm-10">
                                    ...
                                    <br><img height="70px" width="80px" src="{{ asset('uploads/'.$procedure->image_name) }}" alt="No Previous Image.">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                 ...
                                 <input id="checkbox2" type="checkbox" class="form-check-input" name="hide" value="yes" @if($procedure->hide =="yes") checked @endif >Check to hide feature image</label>
                                </div>
                                </div>
                            </div>
