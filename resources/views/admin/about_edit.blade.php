            ...
            <div class="page-title-wrapper">
                <div class="page-title-heading">
                    ...
                    <div><strong>About</strong>
                        <div class="page-title-subheading">Edit {{ $about->title; }}
                        </div>
                    </div>
                </div>
                ...
                <div class="main-card mb-3 card">
                    ...
                    <form action="{{ url('admin/about/'.$about->id) }}" method="POST" enctype="multipart/form-data" >
                        @csrf
                            ...
                            <div class="col-sm-4">
                <input type="text" name="title" id="exampleEmail" value="{{ $about->title }}" class="form-control">
                            </div>
                            </div>                        
                           
                            <div class="position-relative row form-group"><label for="exampleEmail" class="col-sm-2 col-form-label">Order:</label>
                                <div class="col-sm-4">
                    <input type="text" name="order" id="exampleEmail" value="{{ $about->order }}" class="form-control">
                                </div>
                                </div>
                  ...
                  <textarea name="content" id="content" class="form-control">{{ $about->content }}</textarea>
                            ...
                            <div class="position-relative row form-group"><label for="exampleFile" class="col-sm-2 col-form-label">Image: <small class="form-text text-muted">Please Insert Image Only.</small></label>
                                <div class="col-sm-10">
                                    ...
                                    <br><img height="70px" width="80px" src="{{ asset('uploads/'.$about->image_name) }}" alt="No Previous Image.">
                                </div>
                            </div>
                            ...
                            <div class="position-relative row form-group">
                                ...
                                <div class="col-sm-10">
                                 ...
                                 <input id="checkbox2" type="checkbox" class="form-check-input" name="hide" value="yes" @if($about->hide =="yes") checked @endif >Check to hide feature image</label>
                                </div>
                                </div>
                            </div>
